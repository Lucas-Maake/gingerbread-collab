 ...
 * Has a baked look with darker edges and subtle surface variation
 */
export function createGingerbreadTexture(width = 256, height = 256, baseColor = '#CD853F') {
  ...
  // Add subtle baked spots/variation
  ...
  // Add lighter spots (air bubbles in baking)
  ...
  // Add fine noise for grainy cookie texture
 ...
 * Classic red and white spiral pattern
 */
export function createPeppermintTexture(width = 256, height = 256, color1 = '#DC143C', color2 = '#FFFFFF') {
  const canvas = document.createElement('canvas')
  canvas.width = width
  canvas.height = height
  const ctx = canvas.getContext('2d')
  ...
  const segments = 8 // Number of color alternations
 ...
 */
export function createCandyCaneTexture(width = 128, height = 256, color1 = '#DC143C', color2 = '#FFFFFF') {
  const canvas = document.createElement('canvas')
  canvas.width = width
  canvas.height = height
  const ctx = canvas.getContext('2d')
 ...
 * Smooth creamy look with subtle variation
 */
export function createFrostingTexture(width = 128, height = 128, baseColor = '#FFFAF0') {
  const canvas = document.createElement('canvas')
  canvas.width = width
  canvas.height = height
  const ctx = canvas.getContext('2d')
 ...
 */
export function createStarCookieTexture(width = 256, height = 256, baseColor = '#FFD54F') {
  const canvas = document.createElement('canvas')
  canvas.width = width
  canvas.height = height
  const ctx = canvas.getContext('2d')
...
export function getCachedTexture(type, creator, ...args) {
