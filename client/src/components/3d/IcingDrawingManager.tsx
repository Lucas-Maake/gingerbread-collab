...
export default function IcingDrawingManager() {
    ...
    const currentSurfaceType = useRef<SurfaceType>('ground')
    const currentSurfaceId = useRef<string | null>(null)
    ...
    useEffect(() => {
        ...
        const handleMouseDown = (event: MouseEvent) => {
            ...
            currentSurfaceId.current = hit.surfaceId || null
        ...
        const handleMouseUp = (event: MouseEvent) => {
            ...
            if (filteredPoints.length >= 2) {
                ...
                state.createIcing(
                    filteredPoints,
                    0.05, // radius
                    currentSurfaceType.current || 'ground',
                    currentSurfaceId.current || undefined
                ).finally(() => {
