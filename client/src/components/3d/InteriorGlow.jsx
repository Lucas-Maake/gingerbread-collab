 ...
 */
const GlowLight = memo(function GlowLight({ position, normal, scale, color }) {
...
const selectGlowPositions = (state) => {
  const positions = []
  ...
  for (const [id, piece] of pieces.entries()) {
    ...
    if ((isWindow || isDoor) && piece.attachedTo && piece.pos) {
      ...
      let normal = [0, 0, 1] // Default facing +Z
