...
export type SoundTypeEnum = typeof SoundType[keyof typeof SoundType]
...
export interface UseSoundEffectsResult {
    playSound: (soundType: SoundTypeEnum) => void
    toggleMute: () => boolean
    setVolume: (volume: number) => void
    isMuted: () => boolean
    SoundType: typeof SoundType
}
...
export function playGlobalSound(soundType: SoundTypeEnum) {
...
export function setGlobalSfxMuted(muted: boolean) {
    globalMuted = muted
